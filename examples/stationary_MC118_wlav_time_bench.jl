...
ipot_file_fase="ipopt_fase_wlav.out"
ipot_file_wls="ipopt_hyb_wlav.out"
ipot_file_scada="ipopt_scada_wlav.out"
...
name_experiment="stationary_MC118_wlav"
...
for a in [1e-4]
    df_errors, df_conv = run_fase_experiment_stationary_timebench(N, n0, a, min_sigma, result, data_wls_sr, d_prec, d_keys, d_meas_set, nlp_optimizer_hyb, nlp_optimizer_scada, nlp_optimizer_pmu, ipopt_out)
    df_errors[!, :a] .= a
    df_conv[!, :a] .= a
